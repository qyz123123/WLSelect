...
export function TeacherCard({ teacher }: { teacher: TeacherProfile }) {
  ...
  return (
    <Link href={`/teachers/${teacher.id}`} className="block">
      <Card className="overflow-hidden transition hover:border-[var(--primary)] hover:bg-[var(--primary-soft)]">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-5 inline-flex items-center gap-2 text-sm font-medium text-[var(--primary)]">
